...
function Contact() {
  return <main>
    <section className="page-hero contact-head"><Reveal><p className="eyebrow">CONTACT / 05</p><h1>Let's build<br /><span>something useful.</span></h1><p>
  Based in Kenya and available internationally, I help clients with mechanical engineering, fabrication, machine reliability, production systems and digital projects. Have a project or engineering challenge? Start with a message.
</p></Reveal></section>
    <section className="contact-section"><div className="contact-grid">
      <Reveal><a href="https://wa.me/254740967882" target="_blank" rel="noreferrer" className="contact-card edge-box"><div className="contact-icon whatsapp-icon"><FaWhatsapp /></div><span className="contact-label">FASTEST</span><h3>WhatsApp</h3><p>Quick questions, engineering discussions and project consultation from Kenya or internationally.</p><strong>+254 740 967 882 <FaArrowRight /></strong></a></Reveal>
      <Reveal delay={80}><a href="mailto:morara603@gmail.com" className="contact-card edge-box"><div className="contact-icon"><FaEnvelope /></div><span className="contact-label">EMAIL</span><h3>Email</h3><p>Send drawings, specifications, requirements or a detailed engineering project brief.</p><strong>morara603@gmail.com <FaArrowRight /></strong></a></Reveal>
      <Reveal delay={160}><NavLink to="/booking" className="contact-card edge-box"><div className="contact-icon"><FaArrowRight /></div><span className="contact-label">STRUCTURED</span><h3>Book a Session</h3><p>Describe your engineering, fabrication or digital project and request a consultation time.</p><strong>Open booking form <FaArrowRight /></strong></NavLink></Reveal>
    </div></section>
